...
unsigned int map_stored_play[MAP_MAXWIDTH][MAP_MAXHEIGHT];
unsigned int map_stored_org[MAP_MAXWIDTH][MAP_MAXHEIGHT];
...
stObject saved_objects[MAX_OBJECTS];
...
#include "include_c/buttons.c"
#include "include_c/ghosting.c"
#include "include_c/autoblock.c"
